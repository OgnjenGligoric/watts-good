...
INSERT INTO property (latitude, longitude, number_of_floors, request_status, city_id, completion_date, "owner_id", submission_date, address) VALUES (40.7128, -74.0060, 10, 1, 2, '2024-01-01 12:00:00', 1, '2023-12-01 12:00:00', '100 Main Street');

-- Insert into household table
INSERT INTO household (floor_number, is_active, square_meters, apartment_number, last_heartbeat_timestamp, "owner_id", property_id) VALUES (1, false, 50, 101, 1700000000, 1, 2),(1, false, 60, 102, 1700000000, 1, 2),(2, false, 55, 201, 1700000000, 1, 2),(2, false, 70, 202, 1700000000, 1, 1),(3, false, 65, 301, 1700000000, 1, 1),(3, false, 80, 302, 1700000000, 1, 1),(4, false, 75, 401, 1700000000, 1, 1), (4, false, 90, 402, 1700000000, 1, 1),(5, false, 85, 501, 1700000000, 1, 1),(5, false, 100, 502, 1700000000, 1, 1);
